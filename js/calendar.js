function calendar(date) {
  ...
  for(day_counter = 1; day_counter <= days_in_this_month; day_counter++) {
    ...
    if(day == day_counter)
      calendar_html += '<td style="text-align: center; color:darkred"><b>' + day_counter + '</b></td>';
    else
      calendar_html += '<td style="background-color:9999cc;padding:15px; color:000000; text-align: center;"> ' + day_counter + ' </td>';
